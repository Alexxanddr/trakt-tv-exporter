...
TRAKT_OAUTH_CODE = os.environ['TRAKT_OAUTH_CODE']
TMDB_API_KEY = os.environ['TMDB_API_KEY']
TMDB_IMAGE_BASE = os.environ['TMDB_IMAGE_BASE']
...
for item in Trakt['sync/history'].get(pagination=True, per_page=200, start_at=datetime(date.today().year, date.today().month, 1), extended='full'):
